    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-8">
        <div className="space-y-2">
            ...
            <p className="text-muted-foreground">Adicione, edite e gira todos os produtos da plataforma.</p>
        </div>
        <AddProductDialog />
      </div>
      {error ? (
                 ...
                 <Table>
                    ...
                    <TableBody>
                        {products.length > 0 ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={7} className="text-center h-24">Nenhum produto encontrado.</TableCell>
                            </TableRow>
                        )}
                    </TableBody>
                </Table>
